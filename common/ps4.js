...
function setupRW() {
    ...
    debug_log("-> Exploit Completed..Now Runing Jailbreak for 7.55 by Anees khan !!");
    if (window.postExploit)
        window.postExploit();
}

function toggle_payload() {
    document.getElementById("progress").innerHTML = 'Wait Unitil Completed HEN GOLD 2.0b (Anees khan) AND After that EXIT... <br>'
    PLfile = 'goldhen2.bin';
